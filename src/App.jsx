...
export default function App() {
  return (
    <main>
      <section>
        <div>
          <img src={iconSedans} alt="imagem de um carro sendan" />
          <h2 >Sedans</h2>
          ...
          <a href="https://www.webmotors.com.br/sedans" 
          target= "_blank" >Ver mais</a>
        </div>

        <div>
          <img src={iconSuvs} alt="ícone de carros SUV" />
          <h2>SUVs</h2>
        ...
        <div>
          <img src={iconLuxury} alt="ícone dos carro de luxo"/>
          <h2>Luxuosos</h2>
